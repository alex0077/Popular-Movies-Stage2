...
import static com.example.popular_movies.provider.MoviesContract.*;
import com.example.popular_movies.provider.MoviesContract.Movie;
...
import com.example.popular_movies.data.DBaseHelper;

/**
 * Created by Alex on 9/03/2018.
 */
public class MoviesProvider extends ContentProvider{
    ...
    public boolean onCreate() {
        helper = new DBaseHelper(getContext());
        return true;
    }
